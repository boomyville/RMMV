...
- Battler Name + Icon of weapons
	...
	- if(this._actionArray[1].isActor()) { this.drawIcon(this._actionArray[1].weapons()[0].iconIndex, 0, this.fittingHeight(0)); } else if (this._actionArray[1].enemy().meta.srpgWeapon){ this.drawIcon($dataWeapons[this._actionArray[1].enemy().srpgWeapon].iconIndex, 0, this.fittingHeight(0)); }
